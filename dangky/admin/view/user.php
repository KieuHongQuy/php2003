...
$('.timkiem button').click(function(event) {
			...
			window.location.href="index.php?controller=user&action=alluser&keyword="+keyword;
        });
});      
</script>
<div id="page-wrapper">
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX" align="center">
                        ...
                        <td><?=$value['hoten']?></td>
                        <td class="center"><i class="fa fa-trash-o  fa-fw"></i> <a style="cursor:pointer" onclick="deleteCart('index.php?controller=user&action=delete&id=<?=$value['id']?>')"> Xóa</a></td>
                    </tr>
                    <?php }?>
                </tbody>
            </table>
